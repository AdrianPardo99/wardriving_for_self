    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sinr', models.IntegerField(verbose_name='SINR (Signal-to-Interference-plus-Noise Ratio)')),
                ('provider', models.TextField(default='', verbose_name='Provider')),
                ('current_latitude', models.DecimalField(decimal_places=6, default=0, max_digits=9, verbose_name='Latitude')),
                ('current_longitud', models.DecimalField(decimal_places=6, default=0, max_digits=9, verbose_name='Longitude')),
            ],
            options={
